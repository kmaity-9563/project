...
//     let response = str.value.split(" ").length
//     console.log(response);
//     return response;
// }

loadParagraph();
// wordcounter(typingText);
